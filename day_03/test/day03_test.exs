defmodule Day03Test do
  ...
  test "Full examples" do
    assert Day03.closest_intersection_distance("R8,U5,L5,D3", "U7,R6,D4,L4") == 6

    assert Day03.closest_intersection_distance(
  ...
  test "find intersection that is reachable by lowest amount of combined steps" do
    assert Day03.lowest_steps_to_intersection("R8,U5,L5,D3", "U7,R6,D4,L4") == 30

    assert Day03.lowest_steps_to_intersection(
             "R75,D30,R83,U83,L12,D49,R71,U7,L72",
             "U62,R66,U55,R34,D71,R55,D58,R83"
           ) == 610
...
defmodule WireTest do
  ...
  test "build simple routes" do
    ...
    assert Wire.execute_command("U5", {10, 10}) == [
             {10, 15},
             {10, 14},
             {10, 13},
             {10, 12},
